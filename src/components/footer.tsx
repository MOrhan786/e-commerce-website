          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4">
              <div className="border-2 border-white p-1 rounded">
                <Image src="/image/qr-img.png" alt="QR" width={80} height={80}/>
              </div>
              <div className="space-y-2">
              <Image src="/image/g-button.png" alt="QR" width={104} height={30}/>

              <Image src="/image/app-img.png" alt="QR" width={104} height={30}/>
              </div>
            </div>
          </div>
        </div>
